...
export const STORAGE_KEYS = {
  API_CONFIGS: "ysApiConfigs",
  BTN_API_CONFIG: "ysBtnApiConfig",
  CUSTOM_PROMPT_SUMMARY: "ysCustomPromptSummary",
  CUSTOM_PROMPT_TRANSCRIPT: "ysCustomPromptTranscript",
  SUMMARY_CACHE_PREFIX: "ysSummaryCache_",
};